...
'[se]':     (4.80320427e-13, [(3,2), (1,2), -1, 0, 0, 0, 0, 0],  '4.80320427e-10*statC', 'elem. charge GBU', False         ),
'[smu_B]':  (9.27401007e-26, [(5, 2), (1, 2), -1, 0, 0, 0, 0, 0], '9.274010078e-21*erg/statG', 'Bohr magneton GBU', False  ),
}, keys=True)

QUANTITY_LIST = RowCollector(['name','symbol', 'SI', 'CGS', 'AU', 'GAUSS'], [
...
('BohrMagneton',          'BMA',   '[mu_B]',   '[mu_B]',             '[mu_B]',               '[smu_B]',        ),
('Capacitance',           'CAP',   'F',        None,                 None,                   'cm',             ),
('CatalyticActivity',     'CAC',   'kat',      None,                 None,                   None,             ),
('Conductance',           'CON',   'S',        None,                 None,                   None,             ),
('DynamicViscosity',      'DVI',   'Pa*s',     'P',                  None,                   'P',              ),
('ElectricCurrent',       'ECU',   'A',        None,                 '[e]*E_h/[hbar]',       'statA',          ),
('ElectricCharge',        'ECH',   'C',        None,                 '[e]',                  'statC',          ),
('ElectricChargeDensity', 'ECD',   'C/m3',     None,                 '[e]/[a_0]3',           None,             ),
('ElectricPotential',     'EPO',   'V',        None,                 'E_h/[e]',              'statV',          ),
('ElectricDipoleMoment',  'EDM',   'C*m',      None,                 '[e]*[a_0]',            'statC*cm',       ),
('ElectricDisplField',    'EDF',   'C*m2',     None,                 None,                   'statC/cm2',      ),
('ElectricField',         'EFI',   'V/m',      None,                 'E_h/([e]*[a_0])',      'statV/cm',       ),
...
('Inductance',            'IND',   'H',        None,                 None,                   's2/cm',          ),
('Irradience',            'IRR',   'W/m2',     None,                 'E_h2/([hbar]*[a_0]2)', None,             ),
('KinematicViscosity',    'KVI',   'm2/s',     'St',                 None,                   None,             ),
('Length',                'LEN',   'm',        'cm',                 '[a_0]',                'cm',             ),
('LuminousIntensity',     'LIN',   'cd',       None,                 None,                   None,             ),
('LuminousFlux',          'LFL',   'lm',       None,                 None,                   None,             ),
('MagneticField',         'MFI',   'A/m',      'Oe',                 None,                   'statOe',         ),
('MagneticFlux',          'MFL',   'Wb',       'Mx',                 None,                   'statG*cm2',      ),
('MagneticFluxDensity',   'MFD',   'T',        'G',                  '[hbar]/([e]*[a_0]2)',  'statG',          ),
('MagneticDipoleMoment',  'MDM',   'J/T',      None,                 '[hbar]*[e]/[m_e]',     'erg/statG',      ),
