...
('ElectricCurrent',       'ECU',   'A',        None,       '[e]*E_h/[hbar]'),
('ElectricCharge',        'ECH',   'C',        None,       '[e]'),
('ElectricChargeDensity', 'ECD',   'C/m3',     None,       '[e]/[a_0]3'),
('ElectricPotential',     'EPO',   'V',        None,       'E_h/[e]'),
('ElectricDipoleMoment',  'EDM',   'C*m',      'D',        '[e]*[a_0]'),
('ElectricField',         'EFI',   'V/m',      None,       'E_h/([e]*[a_0])'),
('ElectricFieldGradient', 'EFG',   'V/m2',     None,       'E_h/([e]*[a_0]2)'),
('ElectricPolarizability','EPL',   'm2/J',     None,       '[e]2*[a_0]2/E_h'),
('ElectromotiveForce',    'EFO',   'V',        None,       None),
('Energy',                'ENE',   'J',        'erg',      'E_h'),
('EquivalentDose',        'EDO',   'Sv',       None,       None),
('Force',                 'FOR',   'N',        'dyn',      'E_h/[a_0]'),
...
('Irradience',            'IRR',   'W/m2',     None,       'E_h2/([hbar]*[a_0]2)'),
...
('MagneticFluxDensity',   'MFD',   'T',        'G',        '[hbar]/([e]*[a_0]2)'),
('MagneticDipoleMoment',  'MDM',   'J/T',      None,       '[hbar]*[e]/[m_e]'),
('Magnetizability',       'MAG',   'J/T2',     None,       '[e]2*[a_0]2/[m_e]'),
('Mass',                  'MAS',   'kg',       'g',        '[m_e]'),
('Momentum',              'MOM',   'kg*m/s',   None,       '[hbar]/[a_0]'),
('Permittivity',          'PER',   'F/m',      None,       '[e]2/([a_0]*E_h)'),
('PlaneAngle',            'PAN',   'rad',      None,       None),
('Power',                 'POW',   'W',        'erg/s',    None),
('Pressure',              'PRE',   'Pa',       'Ba',       'E_h/[a_0]3'),
...
('Time',                  'TIM',   's',        's',        '[hbar]/E_h'),
('Velocity',              'VEL',   'm/s',      'cm/s',     '[a_0]*E_h/[hbar]'),
