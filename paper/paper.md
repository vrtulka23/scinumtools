...
While these initial applications (v1) were based on earlier, non-public implementations, they informed the design of the present, consolidated framework (v2). The current version generalizes these ideas into a reusable and well-documented software package, with explicit support for reproducible workflows and transparent handling of units and parameters.
